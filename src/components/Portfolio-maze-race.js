  ...
  return (
    <div>
      ...
      <div className={styles.Portfolio}>
        <div style={{ height: '150px', width: '100%' }}><img src='https://raw.githubusercontent.com/samjespersen/samjespersen.com/dev/src/assets/maze-race.png' style={{ height: '100%', width: '100%' }} /></div>
      </div>
